...
| `test-cdk-synthesis.py` | Runs CDK synthesis across a matrix of configuration combinations to catch issues like hardcoded regions or missing context values. |
