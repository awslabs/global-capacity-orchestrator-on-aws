...
**Example:**
```bash
gco inference deploy my-llm -i vllm/vllm-openai:v0.19.1
...
gco inference canary my-llm -i vllm/vllm-openai:v0.19.1

# 25% traffic with 2 canary replicas
gco inference canary my-llm -i vllm/vllm-openai:v0.19.1 -w 25 -r 2
```
