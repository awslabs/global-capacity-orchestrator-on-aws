...
EXAMPLE_METADATA: dict[str, dict[str, str | list[str]]] = {
    ...
    "gpu-job": {
        ...
        "keywords": ["gpu", "nvidia", "cuda", "single gpu"],
    ...
    "multi-gpu-training": {
        ...
        "keywords": ["ddp", "distributed", "pytorch", "multi gpu", "training"],
    ...
    "inference-vllm": {
        ...
        "keywords": ["vllm", "openai", "llm serving", "pagedattention", "inference"],
        "instance_types": ["g5.xlarge", "g5.12xlarge", "g6.xlarge"],
        "use_cases": [
...
DOC_METADATA: dict[str, dict[str, str | list[str]]] = {
    "ANALYTICS": {
        ...
        "topics": ["analytics", "storage", "customization"],
    ...
    "ARCHITECTURE": {
        ...
        "topics": ["architecture", "concepts", "security"],
    ...
    "CUSTOMIZATION": {
        ...
        "topics": ["customization", "architecture"],
    ...
    "RUNBOOKS": {
        ...
        "topics": ["runbooks", "troubleshooting"],
    ...
    "TROUBLESHOOTING": {
        ...
        "topics": ["troubleshooting", "runbooks"],
